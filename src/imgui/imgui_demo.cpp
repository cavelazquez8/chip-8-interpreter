...
static ExampleTreeNode* ExampleTree_CreateDemoTree() {
    ...
    for (int idx_L0 = 0; idx_L0 < IM_ARRAYSIZE(root_names) * root_items_multiplier; idx_L0++) {
        snprintf(name_buf, 32, "%s %d", root_names[idx_L0 / root_items_multiplier],
    ...
    if (ImGui::CollapsingHeader("Configuration")) {
        ...
        if (ImGui::TreeNode("Configuration##2")) {
            ...
            if (io.ConfigDockingWithShift)
                HelpMarker(
                    "Drag from window title bar or their tab to dock/undock. Hold SHIFT to enable "
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable) {
                ...
                ImGui::SameLine();
                HelpMarker(
                    "Enable docking when holding Shift only (allow to drop in wider space, reduce "
                    "visual noise)");
                ...
                HelpMarker(
                    ...
                    "boxes on the target viewport. Useful if rendering of multiple viewport cannot "
                    "be synced. Best used with ConfigViewportsNoAutoMerge.");
                ImGui::Unindent();
            }
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) {
                ...
                ImGui::SameLine();
                HelpMarker(
                    "Toggling this at runtime is normally unsupported (most platform backends "
                    "won't refresh the task bar icon state right away).");
                ImGui::Checkbox("io.ConfigViewportsNoDecoration", &io.ConfigViewportsNoDecoration);
                ImGui::SameLine();
                HelpMarker(
                    "Toggling this at runtime is normally unsupported (most platform backends "
                    "won't refresh the decoration right away).");
                ImGui::Checkbox("io.ConfigViewportsNoDefaultParent",
                                &io.ConfigViewportsNoDefaultParent);
                ImGui::SameLine();
                HelpMarker(
                    "Toggling this at runtime is normally unsupported (most platform backends "
                    "won't refresh the parenting right away).");
                ImGui::Unindent();
            }
        ...
        if (ImGui::BeginMenu("Tools")) {
            ...
            if (!is_debugger_present)
                ImGui::SetItemTooltip(
                    ...
                    "disable the menu option to avoid casual users crashing the "
                    "application.\n\nYou can however always access the Item Picker in "
                    "Metrics->Tools.");
            ImGui::Separator();
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data) {
    ...
    if (ImGui::TreeNode("Tooltips")) {
        ...
        // 'style.HoverFlagsForTooltipNav' depending on whether mouse or gamepad/keyboard is being
    ...
    if (ImGui::TreeNode("Selection State & Multi-Select")) {
        ...
        if (ImGui::TreeNode("Multi-Select (checkboxes)")) {
            ...
            if (ImGui::BeginChild("##Basket", ImVec2(-FLT_MIN, ImGui::GetFontSize() * 20),
                ...
                storage_wrapper.AdapterSetItemSelected = [](ImGuiSelectionExternalStorage* self,
                                                            int n, bool selected) {
            ...
            struct ExampleTreeFuncs {
                static void DrawNode(ExampleTreeNode* node, ImGuiSelectionBasicStorage* selection) {
                    ImGuiTreeNodeFlags tree_node_flags = ImGuiTreeNodeFlags_SpanAvailWidth |
                                                         ...
                                                         ImGuiTreeNodeFlags_OpenOnDoubleClick;
                    tree_node_flags |=
                        ImGuiTreeNodeFlags_NavLeftJumpsBackHere;  // Enable pressing left to jump to
                                                                  // parent
                    ...
                    for (int n = item_begin; n < item_end; n++) {
                        ...
                        if (show_color_button) {
                            ...
                            ImGui::ColorButton("##", ImColor(dummy_col),
                                               ImGuiColorEditFlags_NoTooltip, color_button_sz);
                            ImGui::SameLine();
                        }
...
static void ShowDemoWindowTables() {
    ...
    if (ImGui::TreeNode("Angled headers")) {
        ...
        if (ImGui::BeginTable("table_angled_headers", columns_count, table_flags,
            ...
            ImGui::TableHeadersRow();  // Draw remaining headers and allow access to context-menu
                                       // and other functions.
    ...
    if (ImGui::TreeNode("Sorting")) {
        ...
        if (ImGui::BeginTable("table_sorting", 4, flags, ImVec2(0.0f, TEXT_BASE_HEIGHT * 15),
                              0.0f)) {
            // Declare columns
...
static void ShowDemoWindowInputs() {
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus")) {
        ...
        if (ImGui::TreeNode("Shortcuts")) {
            ...
            // priority when active) (Commmented because the owner-aware version of Shortcut() is
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref) {
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
        if (ImGui::BeginTabItem("Sizes")) {
            ...
            ImGui::SliderAngle("TableAngledHeadersAngle", &style.TableAngledHeadersAngle, -50.0f,
                               +50.0f);
            ImGui::SliderFloat2("TableAngledHeadersTextAlign",
                                (float*)&style.TableAngledHeadersTextAlign, 0.0f, 1.0f, "%.2f");
            ...
            ImGui::SeparatorText("Docking");
            ImGui::SliderFloat("DockingSplitterSize", &style.DockingSeparatorSize, 0.0f, 12.0f,
                               "%.0f");
            ...
            ImGui::SliderFloat2("DisplayWindowPadding", (float*)&style.DisplayWindowPadding, 0.0f,
                                30.0f, "%.0f");
            ImGui::SameLine();
            HelpMarker(
                    ...
                    for (int item_idx = item_min_idx_for_current_line;
                        ...
                        if (item_is_visible) {
                            ...
                            if (display_label) {
                                ...
                                draw_list->AddText(
                                    ImVec2(box_min.x, box_max.y - ImGui::GetFontSize()), label_col,
                                    label);
                            }
                        }
