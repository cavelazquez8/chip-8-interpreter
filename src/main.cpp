...
constexpr std::array<SDL_Keycode, 16> KEYMAP = {SDLK_1, SDLK_2, SDLK_3, SDLK_4, SDLK_q, SDLK_w,
...
class SDLRenderer {
  public:
    ...
    void render(const Chip8& emulator) {
        ...
        SDL_UpdateTexture(texture_, nullptr, pixels.data(), DISPLAY_WIDTH * sizeof(std::uint32_t));
